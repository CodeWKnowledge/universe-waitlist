...
import { joinWaitlist, generateReferralLink } from './services/waitlist/waitlist.service';
import { validateWaitlistForm } from './services/waitlist/waitlist.validation';
import { analytics } from './services/analytics/analytics.service';
import { UNIVERSITIES, USER_ROLES } from './services/waitlist/waitlist.constants';
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center gap-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: 'Bargain Chat', slug: 'bargain-chat', icon: BubbleChatIcon },
                    { label: 'Verified Access', slug: 'verified-access', icon: Shield01Icon },
                  ].map(f => (
                    <Link
                      key={f.slug}
                      to={`/features/${f.slug}`}
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <a
                    href="http://localhost:5174/study-hub"
              ...
              <div className={`hidden lg:flex items-center justify-center p-8 border-l ${ isDark ? 'border-white/5' : 'border-black/6' }`}>
                <div className={`w-full max-w-sm rounded-2xl border overflow-hidden shadow-2xl transition-all ${ isDark ? 'bg-[#0a0f1d] border-white/5' : 'bg-slate-50 border-black/8' }`}>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    {/* CTA strip */}
                    <a 
                      href="http://localhost:5174/marketplace"
